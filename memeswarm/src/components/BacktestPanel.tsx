    ...
    <section className="px-4 pb-6 sm:px-6">
      <div className="rounded-lg border border-void-border bg-void-panel p-4 shadow-panel sm:p-6">
        ...
        <p className="mb-3 font-mono text-[10px] leading-snug text-slate-600">
          ...
          whatever duration you set — fully isolated from your live session, it never touches it. Use it to
          sanity-check the trading logic over a stretch longer than you'd want to sit and watch.
        </p>
